...
HyperlinkColumnsLabelsWithTarget.args = {
  ...
  data: [
    ...
    {
      link: "https://plan.epfl.ch/iframe?q=med09418",
      anchor: "Hall MED 94.18",
    },
  ],
};
...
TagsetColumns.args = {
  ...
  data: [
    ...
    },
    {
      ...
      anchor: "Education",
      tags1: "page,education",
      tags2: "test1,test2,test3",
    },
    {
...
export const reallyLongColumnName: Story = {
  args: {
    ...
    columnsLabels: [
      "EPFL Link",
      "EPFL Anchor with an absolutely and insanely loooooooooooooooooooooooong text with a lot of unnecessary and absolutely gibberish text with no real purpose besides testing the length on it ",
    ],
    data: [
      { link: "https://www.epfl.ch/about/", anchor: "About" },
      { link: "https://www.epfl.ch/education", anchor: "Education" },
...
ColumnsWithRawHTML.args = {
  ...
  data: [
    ...
    {
      link: "https://www.epfl.ch/education",
      anchor: "Education with <i>Italics</i>",
    },
    {
      link: "https://www.epfl.ch/research",
      anchor: "Research with <br /><br /> new line",
    },
    {
      link: "https://www.epfl.ch/innovation/",
      anchor: "Innovation with list: <ul><li>item1</li><li>item2</li></ul>",
    },
    { link: "https://www.epfl.ch/schools/", anchor: "Schools" },
    { link: "https://www.epfl.ch/campus/", anchor: "Campus" },
  ],
